  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Focus Pixel offers premium photography, videography, and creative courses. Based in Kenya, we capture your most precious moments with professional gear."
        />
        <meta
          property="og:title"
          content="Focus Pixel - Professional Media Services"
        />
        <meta
          property="og:description"
          content="Capture your creative moments with our expert team."
        />
      </Helmet>
      <section className="hero" aria-label="Introduction">
        <div className="hero-content">
          ...
          <p className="hero-description">
            ...
            videography, and creative media services designed to bring your
            vision to life. From commercial advertisements to private events, we
            craft visual stories that resonate with your audience.
          </p>
